...
import { LOADING_SPINNER_SHOW_MUTATION, LOGIN_ACTION, GET_USER_DATA_GETTER } from '../../../store/storeconstants';
    ...
    <div class="grid m-0 p-0 min-h-screen">
        <div class="col-12 md:col-5">
            <div class="md:px-8 lg:px-8 px-4 pt-8">
                ...
                <div class="text-900 font-bold md:text-6xl lg:text-6xl text-5xl text-center mb-3"><span class="primary-blue-font">Welcome </span><span class="text-primary"> back!</span></div>
                <div class="text-600 font-bold text-xl text-center mb-6 text-center">Please sign-in to your account</div>
        ...
        <div class="md:col-7 p-0 m-0 shadow-8" style="background-image: url('/img/building/nbte-1.jpeg'); background-size: cover; background-position: center; background-repeat: no-repeat">
