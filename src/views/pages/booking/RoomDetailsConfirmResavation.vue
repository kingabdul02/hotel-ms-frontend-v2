...
<template>
    <Dialog v-model:visible="showBookingDetail" modal header=" " class="montserrat-font" :style="{ width: '60vw' }"
        :breakpoints="{ '1199px': '75vw', '575px': '90vw' }">
        <div class="surface-ground px-4 py-2 md:px-4 lg:px-4">
            <div class="text-900 font-bold text-4xl mb-4 text-center"><span class="text-primary">Booking ID:</span>
                {{ bookingDetails?.booking_id }}</div>
                    ...
                    <div class="p-3 h-full">
                        <div class="h-full flex flex-column">
                            ...
                            <div class="flex align-items-center">
                                ...
                                <span class="ml-2 font-bol text-600">{{ formatDateTime(bookingDetails?.check_in_date)
                                    }}</span>
                            </div>
                            <hr class="my-3 mx-0 border-top-1 border-none surface-border" />
                        ...
                        <div class="h-full flex flex-column">
                            ...
                            <div class="flex align-items-center">
                                ...
                                <span class="ml-2 font-medium text-600">{{
                                    formatDateTime(bookingDetails?.check_out_date) }}</span>
                            </div>
                            <hr class="my-3 mx-0 border-top-1 border-none surface-border" />
                            <router-link :to="`/booking/user/account`">
                                <Button label="View Bookings" icon="pi pi-arrow-circle-right" icon-pos="right"
                    ...
                    <div class="p-3 h-full">
                        <div class="h-full flex flex-column">
                            ...
                            <div class="flex align-items-center font-bold">
                                ...
                                <span class="ml-2 font-medium text-600">{{ bookingDetails?.no_of_guests }}
                                    Guest(s)</span> <span class="mx-3">|</span>
                                <span class="font-bold text-primary text-2xl"><i class="pi pi-users"></i></span>
                                <span class="ml-2 font-medium text-600">{{ bookingDetails?.no_of_nights }}
                                    Night(s)</span>
                            </div>
                            <hr class="my-3 mx-0 border-top-1 border-none surface-border" />
                ...
                <div class="grid p-fluid">
                    ...
                    <div class="col-12 md:col-6 lg:col-6">
                        <div v-if="!confirmBooking" class="pt-8">
                            ...
                            <router-link
                                :to="`/booking/rooms/details/${route.params.id}/payment/${bookingDetails?.booking_id}`">
                                <Button :disabled="!isAuthenticated" style="width: 230px;" label="Payment"
                                    class="px-5 py-3 montserrat-font mr-4" severity="info" icon="pi pi-arrow-right"
                                    iconPos="right" />
                            </router-link>

                            <Button :disabled="!isAuthenticated" style="width: 230px;"
                                @click="showBookingDetail = true; fetchBookingDetails" label="Details" icon="pi pi-eye"
                                iconPos="right" class="px-5 py-3 montserrat-font" />
                        </div>
                        <div v-if="confirmBooking" class="pt-8">
                            <div class="text-900 text-4xl md:text-6xl lg:text-6xl font-bold mb-3">
                                Confirm Reservation
                            ...
                            />
                                ...
                                <Button style="width: 200px;" label="Confirm Booking"
                                    class="px-5 py-3 montserrat-font mr-4 mt-4" icon="pi pi-arrow-right" iconPos="right"
                                    @click="bookRoom" />
                                <Button style="width: 200px;" label="Cancel Booking"
                                    class="px-5 py-3 montserrat-font p-button-danger mt-4" icon="pi pi-times"
                                    iconPos="right" @click="confirmBooking = false;" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 md:col-6 lg:col-6">
                ...
                <div class="grid px-6">
                    <div class="col-12 md:col-6 lg:col-6">
                        <div class="grid">
                            <div class="flex align-items-center justify-content-center mr-2">
                                <img src="/img/icons8-kitchen-64.png" alt="RevUP Logo" height="20"
                    ...
                    <div class="col-12 md:col-6 lg:col-6">
                        <div class="grid">
                            <div class="flex align-items-center justify-content-center mr-2">
                                <img src="/img/icons8-pets-50.png" alt="RevUP Logo" height="20"
                                    class="img-fluid img-fit">
                            </div>
                            <div>
                    ...
                    <div class="col-12 md:col-6 lg:col-6">
                        <div class="grid">
                            <div class="flex align-items-center justify-content-center mr-2">
                                <img src="/img/icons8-tumble-dryer-50.png" alt="RevUP Logo" height="20"
                                    class="img-fluid img-fit">
                            </div>
                            <div>
                                <h2 class="montserrat-font mt-3 text-xl text-700 font-bold">Free washer - in building
                                </h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 md:col-6 lg:col-6">
                        <div class="grid">
                            <div class="flex align-items-center justify-content-center mr-2">
                                <img src="/img/icons8-glyph-48.png" alt="RevUP Logo" height="20"
                                    class="img-fluid img-fit">
                            </div>
                            <div>
