    ...
    <div class="grid">
        <div class="col-12">
            <div class="card">
                ...
                <DataTable ref="dt" :value="items" v-model:selection="selectedItem" :rowHover="true"
                    ...
                    <Column headerStyle="min-width:10rem;">
                        <template #body="slotProps">
                            ...
                            <Button icon="pi pi-trash" class="mt-2 p-button-text" severity="warning" rounded
                                @click="confirmDeleteRoomType(slotProps.data)" />
                        </template>
                    </Column>
                </DataTable>

                <Dialog v-model:visible="itemDialog" modal style="width: 600px" header="RoomType Details"
                    :closable="false">
                    <div class="field">
                    ...
                    <div class="field">
                        ...
                        <ColorPicker id="chart_color_code" v-model="item.chart_color_code" required inputId="cp-hex"
                            format="hex" class="mb-3 mr-2" />
                        <small v-if="validationErrors.chart_color_code" class="p-error">{{
                            validationErrors.chart_color_code }}</small>
                    </div>
                ...
                <ConfirmDialog v-model:visible="deleteItemsDialog" header="Confirm"
                    icon="pi pi-exclamation-triangle" acceptLabel="Yes" rejectLabel="No" acceptClass="p-button-danger"
                    @accept="deleteSelectedRoomTypes">
                    <template #message>
