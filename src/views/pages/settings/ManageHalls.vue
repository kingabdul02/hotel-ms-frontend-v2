...
<template>
    <Dialog v-model:visible="detailsDialog" modal header=" " :style="{ width: '60vw' }">
        <div class="surface-section">
            ...
            <div class="text-500 mb-5">{{ item.description }}</div>
            ...
            <div v-if="itemDialog" class="card">
                ...
                <div class="p-fluid formgrid grid">
                    <div class="field col-12 md:col-6">
                        ...
                        <InputNumber id="capacity" v-model="item.capacity" required class="w-full" placeholder="Enter capacity" />
                        <small v-if="validationErrors.capacity" class="p-error">{{ validationErrors.capacity }}</small>
                    </div>
                ...
                >
                    ...
                    <Column headerStyle="min-width:10rem;">
                        <template #body="slotProps">
                            ...
                            <Button icon="pi pi-pencil" class="mr-2 p-button-text" severity="success" rounded @click="editItem(slotProps.data)" />
                            <Button icon="pi pi-trash" class="p-button-text" severity="warning" rounded @click="confirmDeleteItem(slotProps.data)" />
                        </template>
                    </Column>
                </DataTable>

                <ConfirmDialog v-model:visible="deleteItemsDialog" header="Confirm" icon="pi pi-exclamation-triangle" acceptLabel="Yes" rejectLabel="No" acceptClass="p-button-danger" @accept="deleteSelectedItems">
                    <template #message>
