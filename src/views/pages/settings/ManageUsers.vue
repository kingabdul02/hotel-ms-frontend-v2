        ...
        <div class="col-12">
            <div v-if="recordDialog" class="card">
                ...
                <div class="p-fluid formgrid grid">
                    ...
                    <div class="field col-12 md:col-6">
                        ...
                        <InputText id="address" v-model="record.address" required autoFocus class="w-full"
                    ...
                    <div class="field col-12 md:col-6">
                        ...
                        <InputText id="email" v-model="record.email" required autoFocus class="w-full"
                            placeholder="Enter email" />
                        <small v-if="validationErrors.email" class="p-error">{{ validationErrors.email
                            }}</small>
                    </div>
                    <div class="field col-12 md:col-6">
                        <label for="password">Password</label>
                        <InputText id="password" v-model="record.password" required autoFocus class="w-full"
                            placeholder="Enter password" />
                        <small v-if="validationErrors.password" class="p-error">{{ validationErrors.password
                            }}</small>
                    </div>
                    <div class="field col-12 md:col-6">
                        <label for="password_confirmation">Confirmation</label>
                        <InputText id="password_confirmation" v-model="record.password_confirmation" required autoFocus class="w-full"
                            placeholder="Enter confirmation" />
                        <small v-if="validationErrors.password_confirmation" class="p-error">{{ validationErrors.password_confirmation
                            }}</small>
                    </div>
                    <div class="field col-12 md:col-6">
                        <label for="role">Role</label>
                        <Dropdown id="role" v-model="record.role" :options="[{name:'Manager'},{name:'FrontDesk'},{name:'InventoryStaff'}]" optionLabel="name"
                            optionValue="name" placeholder="Select a Role" class="w-full" />
                        <small v-if="validationErrors.role" class="p-error">{{ validationErrors.role
                            }}</small>
                    </div>
                </div>
                <hr>
            ...
            <div  v-if="!recordDialog" class="card shadow-1">
                                    ...
                                    <div class="flex flex-column md:flex-row justify-content-between md:align-items-center flex-1 gap-4">
                                        ...
                                        <div class="flex flex-column md:align-items-end gap-5">
                                            ...
                                            <div class="flex flex-row-reverse md:flex-row gap-2">
                                                ...
                                                <Button v-if="item.is_active === true" icon="pi pi-user-minus" label="Deactivate" class="flex-auto md:flex-initial white-space-nowrap p-button-danger" @click="confirmUserDeactivation(item?.id, item?.name)" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <Dialog v-model:visible="confirmDeactivationModal" modal header="Confirm User Deactivation" :style="{ width: '30rem' }">
                    <p>Are you sure you want to Deactivate <strong>{{ username }}</strong>?</p>
                    <div class="flex justify-content-end gap-2">
                        <Button type="button" label="No" severity="secondary"
                            @click="confirmDeactivationModal = false"></Button>
                ...
                <Dialog v-model:visible="confirmActivationModal" modal header="Confirm User Activation" :style="{ width: '30rem' }">
                    ...
                    <div class="flex justify-content-end gap-2">
                        <Button type="button" label="No" severity="secondary"
                            @click="confirmActivationModal = false"></Button>
